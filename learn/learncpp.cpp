...
string tempObjectFun(){...} string retVal = tempObjectFun();
...
true && false // Performs **logical and** to yield false
    ...
    false                // Performs **logical or** to yield true
                ...
                4
                << 1 // Shifts bits of 4 to left by 1 to give 8
                // x << n can be thought as x * 2^n

                // **>>** Right Shift Operator
                // >> shifts bits to the right
                4 >>
            1 // Shifts bits of 4 to right by 1 to give 2
            // x >> n can be thought as x / 2^n

            ~4 // Performs a bitwise not
            4 |
        3 // Performs bitwise or
                4 &
                3 // Performs bitwise and
                4 ^
            3 // Performs bitwise xor
